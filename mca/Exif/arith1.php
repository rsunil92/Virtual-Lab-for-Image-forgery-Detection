   ...
   <div id="Mosaic" class="Mosaic_jpg"  >
	...
	<div class="viewer ui-corner-all">
	  <div class="content-conveyor ui-helper-clearfix">
	    <div class="item">
	      <h2>Start</h2>
	      <img src="images/Mosaic.png" alt="picture" width="140px" height="140px"/>
	      <dl class="details ui-helper-clearfix">
		<dt>Select a portion of the Mosaic on the Right and Transform... </dt>
	      </dl>
	    </div>
	  </div>
	</div>
    ...
    <div id="Layer-4" class="InputLayer_jpg"  >
      <img src="images/Layer-4.jpg" width="281" height="281" alt="InputLayer" /></div>
...
<div id="nextBox">
      ...
      <button1>Select Image</button1>      <button4>Reset</button4>
      <button2>Run</button2>
      <br/><br/>
