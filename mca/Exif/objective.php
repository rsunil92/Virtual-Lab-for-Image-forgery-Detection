...
<title>Introduction - Virtual Lab</title>
    ...
    <div id="Layer-3" class="TopBar_jpg"  >
      ...
      <div id="Layer-6" class="IIIT"  >
        <img src="images/iiit.png" width="100" height="70" alt="IIIT" class="pngimg" />
			...
			<div id="topMenu">
			<h1>VIRTUAL LAB for Image Forgery Detection</h1>
<div class="home">
<a href="../Vlab/List of experiments.html">home</a>
</div>

			<div class="menu">
<ul>
<li><sel><a href="objective.php" target="_self" >Objective</a>
</sel></li>
...
color: black;" >
<div>
<b> Exif MetaData - Objectives </b>
      <ul>
	<li>
	  <p>
To Extract Exif data from the Images.
	  </p>
	</li>
      </ul>
    </li>
